...
numeric_columns <- sapply(chess_dataset, is.numeric)

# Plotting the distribution of numerical features
ggplot(gather(chess_dataset[, numeric_columns]), aes(value)) +
...
ELODiff <- with(chess_dataset, white_rating-black_rating)

chess_dataset$rating_difference <- ELODiff
